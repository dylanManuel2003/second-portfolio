      ...
      <section className=" w-[100%] h-auto min-h-[100vh] bg-gray-700">
        <div className='w-[90%] h-[80%] py-12 mx-auto flex flex-col lg:flex-row justify-start items-start'>
          <div className='flex flex-col w-[100%] lg:w-[40%] h-auto'>
            ...
            <div className='text-xl flex flex-col lg:flex-row w-[100%] justify-between mt-9 items-center'>
              ...
              <Link href='https://github.com/dylanManuel2003/countries-app'>
                <a className='w-[240px] h-auto p-2 mb-2 font-semibold text-center text-white duration-500 bg-gray-900 border-2 border-black lg:mb-0 font-Montserrat hover:bg-gray-500' target='_blank'>
          ...
          <main className='flex flex-col m-auto lg:m-0 w-[90%] lg:w-[60%] h-auto text-white lg:pl-10 text-center lg:text-left'>
            ...
            <p className='text-xl'>This project presents a simple interface, the app allows you to filter by country and see statistics of that same country such as population, capital, region, among others<br/>
